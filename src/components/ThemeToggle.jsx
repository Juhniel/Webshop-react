export default function ThemeToggle({ toggle }) {
  ...
  return (
    ...
    >
      <div id="toggle" className="rounded-full w-4 h-4 bg-teal-500 dark:bg-teal-800 relative ml-0 dark:ml-6 pointer-events-none transition-all duration-300 ease-out">
      </div>
    </button>
  );
}
